          ...
          <div className="space-y-4 px-4 pb-4 pt-4 sm:px-5 sm:pb-5">
            ...
            {result && active && !scanMutation.isPending ? (
              <div className="space-y-4">
                ...
                <div><Label htmlFor="scannerStake">Demo stake</Label><Input id="scannerStake" className="mt-2" type="number" inputMode="decimal" min="1" max="500" step="1" value={stake} onChange={(event) => setStake(event.target.value)} /><p className="mt-1 text-xs text-muted-foreground">Minimum 1 USD | Maximum 500 USD | Available {balance.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })} USD</p></div>
